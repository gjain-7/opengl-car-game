...
TextRenderer::TextRenderer(int SCR_WIDTH, int SCR_HEIGHT) : shader("shaders/text.vs", "shaders/text.fs") {
    // Load text
    int err = LoadFont("res/fonts/Antonio-Bold.ttf");
    if (err) {
        exit(1);
    }
    LoadShader(SCR_WIDTH, SCR_HEIGHT);
}

void TextRenderer::LoadShader(int SCR_WIDTH, int SCR_HEIGHT) {
